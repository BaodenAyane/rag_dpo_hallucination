...
Example:
  python scripts/04_generate_baseline.py \
    --retrieval_file data/retrieval/nq_train_bm25_top10_full_5k.jsonl \
    --output data/generation/base_train_outputs_top10_full_5k.jsonl \
...
Multi-GPU sharding example:
  CUDA_VISIBLE_DEVICES=0 python scripts/04_generate_baseline.py \
    --retrieval_file data/retrieval/nq_train_bm25_top10_full_10k.jsonl \
    --output data/generation/base_train_outputs_top10_full_10k_part0.jsonl \
    --model_name Qwen/Qwen2.5-7B-Instruct \
  ...
  CUDA_VISIBLE_DEVICES=1 python scripts/04_generate_baseline.py \
    --retrieval_file data/retrieval/nq_train_bm25_top10_full_10k.jsonl \
    --output data/generation/base_train_outputs_top10_full_10k_part1.jsonl \
    --model_name Qwen/Qwen2.5-7B-Instruct \
    --top_k 10 --max_new_tokens 64 --max_input_length 4096 \
